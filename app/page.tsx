...
// Charger le composant 3D avec gestion d'erreurs améliorée
...
export default function Home() {
  ...
  const handleRenderError = (error: Error, errorInfo: React.ErrorInfo) => {
    console.error('Main render error:', error, errorInfo)
            ...
            <div className="max-w-7xl mx-auto">
              ...
              {isMobile ? (
                <div className="space-y-6 pb-32">
                  {/* Objet 3D Mobile avec ErrorBoundary */}
                  <div className="relative">
                    <ErrorBoundary 
                      fallback={
                        <div className="h-[280px] w-full bg-gray-900 rounded-lg flex items-center justify-center border border-gray-700">
                          <div className="text-center p-6">
                            <div className="text-gray-400 text-sm mb-2">Expérience 3D non disponible</div>
                            <div className="text-xs text-gray-500">Erreur de rendu 3D</div>
                          </div>
                        </div>
                      }
                    >
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 xl:gap-16 items-start">
                  ...
                  <div className="relative order-2 lg:order-1">
                    <div className="relative">
                      <ErrorBoundary 
                        fallback={
                          <div className="h-[350px] lg:h-[400px] xl:h-[500px] w-full bg-gray-900 rounded-lg flex items-center justify-center border border-gray-700">
                            <div className="text-center p-6">
                              <div className="text-gray-400 text-sm mb-2">Expérience 3D non disponible</div>
                              <div className="text-xs text-gray-500">Erreur de rendu 3D</div>
                            </div>
...
>>>>>>> 72728944d97bcb196631e03f728627e6f048088e
